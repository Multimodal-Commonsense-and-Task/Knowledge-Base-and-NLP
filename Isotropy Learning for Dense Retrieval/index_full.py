...
if __name__ == "__main__":
    ...
    indexer = ColBERTIndexer(model_path, index_path, f"{dataset}", chunksize=6, rank=rank, qidf=qidf)
    corpus_iter, cbpid_to_id, _id_to_cbpid = read_corpus(f"/data/beir/{dataset}/corpus.jsonl")
