...
class Arguments():
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument('--regularizer', dest='regularizer', default=None, type=str)
        self.add_argument('--reg_lambda', dest='reg_lambda', default=-5.0, type=float)
        ...
        self.add_argument('--idf', dest='idf', default=None, type=str)
        self.add_argument('--qidf', dest='qidf', default=None, type=str)
        self.add_argument('--pmi', dest='pmi', default=False, action='store_true')
