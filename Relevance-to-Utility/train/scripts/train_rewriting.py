...
def main():
    ...
    eval_dataset = GenerationDataset(raw_eval_data, tokenizer)
    ...
    eval_dataloader = DataLoader(
        eval_dataset, shuffle=False, collate_fn=partial(train_collate_fn, tokenizer=tokenizer), batch_size=args.per_device_eval_batch_size)
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
            ...
            if accelerator.sync_gradients:
                ...
                if completed_steps > 0 and completed_steps % args.eval_steps == 0:                 
                    ...
                    for batch in tqdm(eval_dataloader):
                        ...
                        ### Compute generation loss instead of ndcg
                        with torch.no_grad():
                            outputs = model(tokenized_input)
        ...
        if True or args.checkpointing_steps == "epoch": # Saving every epoch
